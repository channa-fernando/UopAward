...
@Service
public class JAYASEKARAPRIZEService {
        ...
        public ResponseEntity<String> getFacultyAward(MultipartFile file, List<Subject> subjects) {
            ...
            // GPA Calculation
            List<Student> studentListJAYASEKARA = new ArrayList<>();
            for (Student student : studentList) {
                ...
                boolean isEligibleForJYS = false;
                for (Map<String, String> result : student.getResultsMap()) {
                    for (Map.Entry<String, String> entry : result.entrySet()) {
                        ...
                        if (subjectFromCode.isPresent()) {
                            ...
                            if (code.contains("EE549")) {
                                isEligibleForJYS = true;
                            }
                            //GPA Calculation
                ...
                //Check The Eligibility for JAYASEKARA
                if(isEligibleForJYS) {
                    studentListJAYASEKARA.add(student);
                }
