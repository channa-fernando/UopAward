...
@Service
public class MAHALINGAMPRIZEService {
            ...
            public ResponseEntity<String> getFacultyAward(MultipartFile file, List<Subject> subjects) {
                ...
                // GPA Calculation
                List<Student> studentListMAHALINGAM = new ArrayList<>();
                for (Student student : studentList) {
                    ...
                    boolean isEligibleForMGM = false;
                    boolean isEligibleForME205 = false;
                    boolean isEligibleForME301 = false;
                    ...
                    for (Map<String, String> result : student.getResultsMap()) {
                        for (Map.Entry<String, String> entry : result.entrySet()) {
                            ...
                            if (subjectFromCode.isPresent()) {
                                ...
                                if (code.contains("ME201") || code.contains("ME211")) {
                                    isEligibleForMGM = true;
                                }

                                if (code.contains("ME205")) {
                                    isEligibleForME205 = true;
                                }
                                if (code.contains("ME301")) {
                                    isEligibleForME301 = true;
                                }
                    ...
                    //Check The Eligibility for MAHALINGAM
                    if(isEligibleForMGM) {
                        studentListMAHALINGAM.add(student);
                    }

                    if(isEligibleForME205) {
                        studentListMAHALINGAM.add(student);
                    }

                    if(isEligibleForME301) {
                        studentListMAHALINGAM.add(student);
                    }
