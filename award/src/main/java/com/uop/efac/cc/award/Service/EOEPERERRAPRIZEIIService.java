...
import java.util.stream.Collectors;
    ...
    @Service
    public class EOEPERERRAPRIZEIIService {
        ...
        public ResponseEntity<String> getFacultyAward(MultipartFile file, List<Subject> subjects) {
            ...
            // GPA Calculation
            List<Student> studentListEOEII = new ArrayList<>();
            for (Student student : studentList) {
                ...
                boolean isEligibleForEOEII = false;
                for (Map<String, String> result : student.getResultsMap()) {
                    for (Map.Entry<String, String> entry : result.entrySet()) {
                        ...
                        if (subjectFromCode.isPresent()) {
                            ...
                            if (code.contains("CE207") || code.contains("CE212")) {
                                isEligibleForEOEII = true;
                            }
                            //GPA Calculation
                ...
                //Check The Eligibility for EOEI
                if(isEligibleForEOEII) {
                    studentListEOEII.add(student);
                }
