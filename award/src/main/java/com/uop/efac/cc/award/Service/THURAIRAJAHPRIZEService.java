...
import java.util.stream.Collectors;
  ...
  @Service
  public class THURAIRAJAHPRIZEService {
       ...
       public ResponseEntity<String> getFacultyAward(MultipartFile file, List<Subject> subjects) {
            ...
            // GPA Calculation
            List<Student> studentListTHURAIRAJAH = new ArrayList<>();
            ...
            boolean isEligibleForTRP = false;
            ...
            for (Map<String, String> result : student.getResultsMap()) {
                for (Map.Entry<String, String> entry : result.entrySet()) {
                    ...
                    if (subjectFromCode.isPresent()) {
                        ...
                        if (code.contains("CE310")) {
                            isEligibleForTRP = true;
                        }
                        //GPA Calculation
                ...
                //Check The Eligibility for THURAIRAJAH
            if(isEligibleForTRP) {
                studentListTHURAIRAJAH.add(student);
            }
