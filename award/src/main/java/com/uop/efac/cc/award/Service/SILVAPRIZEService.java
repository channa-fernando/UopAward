...
@Service
public class SILVAPRIZEService {
        ...
        public ResponseEntity<String> getFacultyAward(MultipartFile file, List<Subject> subjects) {
            ...
            // GPA Calculation
            List<Student> studentListSILVA = new ArrayList<>();
            for (Student student : studentList) {
                ...
                boolean isEligibleForSLA = false;
                for (Map<String, String> result : student.getResultsMap()) {
                    for (Map.Entry<String, String> entry : result.entrySet()) {
                        ...
                        if (subjectFromCode.isPresent()) {
                            ...
                            if (code.contains("CE203") || code.contains("CE210")) {
                                isEligibleForSLA = true;
                            }
                            //GPA Calculation
                ...
                //Check The Eligibility for SILVA
                if(isEligibleForSLA) {
                    studentListSILVA.add(student);
                }
