...
public enum Award {
    ...
    AWARD21("REGULATIONS GOVERNING THE AWARD OF HERONAREERA PRIZE FOR COMPUTER ADED STRUCTURAL DESIGN"),
    AWARD22("REGULATIONS GOVERNING THE AWARD OF MP RANAWEERA PRIZE FOR FINITE ELEMENT METHODS IN SOLID MECHANICS"),
    AWARD23("PROFESSOR TDMA SAMUEL PRIZE FOR AND ENTHUSIASM AND EXCELLENCE IN ENGINEERING MATHEMATICS"),
    AWARD24("PROFESSOR JA GUNAWARDENA PRIZE FOR THE BEST PERFORMANCE IN CONTROL ENGINEERING"),
    AWARD25("PROFESSOR JA GUNAWARDENA PRIZE FOR THE BEST PERFORMANCE IN ELECTRONICAL ENGINEERING");
